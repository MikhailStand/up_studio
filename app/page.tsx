...
import { FamilySection, LocationSection, MorningSection, OffersSection, ReviewsSection, SocialLinks, scheduleUrl } from "./studio-updates";
...
export default function Home() {
  ...
  return <main>
    <header className="nav-wrap">
      ...
      <nav aria-label="Основная навигация"><a href="#adults">Взрослым</a><a href="#kids">Детям</a><a href="#family">Семейный тариф</a><a href="#offers">Акции</a><a href="#reviews">Отзывы</a><a href={scheduleUrl} target="_blank" rel="noreferrer">Расписание ↗</a></nav>
    ...
    <div className={`quick-menu ${menuOpen ? "is-open" : ""}`} id="quick-menu" aria-hidden={!menuOpen}>
      <div className="quick-menu-links"><a href={scheduleUrl} target="_blank" rel="noreferrer" onClick={closeMenu}>Расписание и запись ↗</a><a href="#schedule" onClick={closeMenu}>Утренние занятия · 10:00–13:00</a><a href="#adults" onClick={closeMenu}>Направления для взрослых</a><a href="#adult-prices" onClick={closeMenu}>Цены для взрослых</a><a href="#kids" onClick={closeMenu}>Направления для детей</a><a href="#kids-prices" onClick={closeMenu}>Цены для детей</a><a href="#family" onClick={closeMenu}>Семейный тариф</a><a href="#offers" onClick={closeMenu}>Акции</a><a href="#reviews" onClick={closeMenu}>Отзывы</a><a href="#about" onClick={closeMenu}>О студии</a><a href="#location" onClick={closeMenu}>Адрес и карта</a><a href="#booking" onClick={closeMenu}>Контакты и запись</a></div>
    ...
    <section className="hero" id="top"><div className="hero-photo" role="img" aria-label="Фитнес-тренировка в светлой студии" /><div className="hero-shade" /><div className="hero-copy"><p className="eyebrow"><span /> Фитнес для всей семьи в Королёве</p><h1>Двигайтесь<br /><em>ввысь</em></h1><div className="hero-bottom"><p>Современная студия фитнеса и воздушной гимнастики. Групповые занятия, профессиональные тренеры и бережный подход к каждому телу.</p><a className="hero-morning" href="#schedule">Утренние занятия <strong>10:00–13:00</strong><span aria-hidden="true">↗</span></a><nav className="hero-quick-links" aria-label="Быстрые переходы"><a href="#adults">Взрослым</a><a href="#kids">Детям</a><a href="#family">Всей семьёй</a><a href={scheduleUrl} target="_blank" rel="noreferrer">Расписание ↗</a></nav></div></div><div className="hero-info"><span>Королёв · ул. Академика Легостаева, 8 · секция 9</span><a href="#reviews">★ 5,0 на Яндекс Картах</a></div></section>
    ...
    <section className="booking section" id="booking"><div className="booking-copy"><h2>Первый шаг —<br /><em>просто попробовать</em></h2><p>Выберите занятие в расписании или напишите администратору. Поможем подобрать направление и удобное время для вас и вашей семьи.</p><SocialLinks /></div><div className="booking-phone-card"><span>Студия «Ввысь»</span><a href={`tel:${phone}`}>+7 980 421-90-92</a><p>Утренние и вечерние занятия</p><a className="call-button" href={scheduleUrl} target="_blank" rel="noreferrer">Расписание и запись <span className="link-arrow" aria-hidden="true">↗</span></a></div></section>
    <LocationSection />

    <footer id="contacts"><div className="footer-top"><a className="brand footer-brand" href="#top"><span className="brand-mark">В</span><span>студия<br />Ввысь</span></a><h2>До встречи<br /><em>на тренировке</em></h2><div className="footer-contacts"><p>Московская область, Королёв<br />ул. Академика Легостаева, 8, секция 9</p><a className="footer-phone" href={`tel:${phone}`}>+7 980 421-90-92</a><div className="footer-links"><a href="https://t.me/upfitstudiokorolev" target="_blank" rel="noreferrer"><span>Telegram</span><span aria-hidden="true">↗︎</span></a><a href="https://vk.com/upfitstudio" target="_blank" rel="noreferrer"><span>ВКонтакте</span><span aria-hidden="true">↗︎</span></a><a href={mapUrl} target="_blank" rel="noreferrer"><span>Открыть на карте</span><span aria-hidden="true">→</span></a></div></div></div><div className="footer-bottom"><span>© 2026 Студия «Ввысь»</span><span>Фитнес для всей семьи</span><a href={scheduleUrl} target="_blank" rel="noreferrer">Расписание ↗</a><a href="#top">Наверх ↑</a></div></footer>
  </main>;
}
